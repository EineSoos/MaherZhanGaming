...
public class GUI extends JFrame implements ActionListener {
    ...
    public GUI(Automat automat) {
        ...
        // new dimension erstellt abstand zwischen die komponenten in pixels
        ...
        // TextField um die eingegebene nummern anzuzeigen
        ...
        //erstellung von buttons von 1-9
        ...
        //erstellung von einem panel um der restliche buttons dort einzufügen (0.50€, 1.00€, ...)
        ...
        for (int i = 1; i <= automat.getProduktListe().size(); i++) {
            ...
            JLabel nummerLabel = new JLabel("Nummer " + i, SwingConstants.CENTER);
            JLabel preisLabel = new JLabel("Preis: " + String.format("%.2f", automat.getProdukt(i).getPreis(), SwingConstants.CENTER));

            produktPanel.add(bilderLabel, BorderLayout.CENTER);
            produktPanel.add(nummerLabel, BorderLayout.SOUTH);
            produktPanel.add(preisLabel, BorderLayout.NORTH);
